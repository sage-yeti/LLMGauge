...
The current curated catalog contains 20 model variants and 26 GPU profiles. It is a reviewed starting set, not an exhaustive or automatically refreshed inventory. Model coverage now includes Llama 3.2 1B/3B, Llama 3.1 8B, and Llama 3.3 70B; Gemma 3 1B/4B/12B/27B; Qwen2.5 3B/7B, Qwen2.5-Coder 7B, and Qwen3 4B/8B/14B/32B; Phi-3.5 Mini and Phi-4 Mini; Mistral 7B, Mistral Nemo 12B, and Mistral Small 3.2 24B. Mistral's documentation now marks Small 3.2 deprecated for new integrations; the entry is included for local GGUF memory planning, not as an API recommendation. GPU coverage includes older NVIDIA cards and the RTX 50-series 5060 Ti, 5070, 5070 Ti, 5080, and 5090; AMD RDNA 2/3/4 including RX 9060 XT; Intel Arc Alchemist/Battlemage; and AMD Radeon 780M integrated graphics. The selection fills documented size and memory-capacity gaps rather than aiming for exhaustive SKU coverage.
